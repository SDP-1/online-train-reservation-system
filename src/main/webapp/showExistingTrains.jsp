...
<body>
    ...
    <main>
        ...
        <section class="add-manager-section">
            ...
            <!-- Create a table to display train information -->
		<table border="1">
		    <caption>Train Information</caption>
		    <tr>
		        <th>Train ID</th>
		        <th>Train Name</th>
		    ...
		    <c:forEach var="train" items="${trains}">
		        <tr>
		            ...
		            <td><c:out value="${train.start}" /></td>
		            <td><c:out value="${train.end}" /></td>
		            <td><c:out value="${train.seatCount}" /></td>
		            <td><c:out value="${train.availableSeatCount}" /></td>
		        </tr>
		    </c:forEach>
		</table>
