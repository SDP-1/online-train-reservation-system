...
<head>
    ...
    <title>Admin update train</title>
    <style>
...
<body>
    ...
    <main>
        ...
        <section class="add-manager-section">
            <h2>Update Train Available Seat Count:</h2>
            <form action="updateTrainServlet" method="post">
                ...
                <div class="form-group">
                    <label for="name">Available Seat Count:</label>
                    <input type="text" id="name" name="sc" required>
                </div>
