...
<body>
	...
	<%-- Display the login message if it's set --%>
	<%
	...
	<div class="container" style="margin-top: 50px">
		<div class="welcome-container">
			<p class="welcome-message">Welcome to Travel Buddy Online Train
		...
		<p>
			Don't have an account? <a href="createAccount.jsp">Register</a>
		</p>
		<p>
			Admin? <a href="adminLogin.jsp">Login as Admin</a>
		</p>
		<p>
			Manager? <a href="managerLogin.jsp">Login as Manager</a>
		</p>
	</div>
