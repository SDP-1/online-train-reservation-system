...
<head>
    ...
    <title>Admin show managers</title>
    <style>
...
<body>
    ...
    <main>
		...
		<table border="1">
		    <caption>Managers Information</caption>
		    <tr>
		        <th>Manager ID</th>
		        <th>Manager Name</th>
		        <th>Manager Email</th>
		    ...
		    <c:forEach var="mgr" items="${managers}">
		        <tr>
		            <td><c:out value="${mgr.id}" /></td>
		            <td><c:out value="${mgr.name}" /></td>
		            <td><c:out value="${mgr.email}" /></td>
		            <td><c:out value="${mgr.phone}" /></td>
		        </tr>
		    </c:forEach>
		</table>
