...
<head>
    ...
    <title>Admin remove train</title>
    <style>
...
<body>
    ...
    <main>
        ...
        <section class="add-manager-section">
            <h2>Remove Train from the System</h2>
            <form action="removeTrainServlet" method="post">
                <div class="form-group">
                    <label for="id">Train ID:</label>
                    <input type="text" id="id" name="tid" required>
                </div>
                ...
                <div class="form-group">
                    <input type="submit" name="submit" value="Remove Train" class="btn">
                </div>
            </form>

            <p>Click Below to See Existing Trains:</p>
		<form action="TrainListServlet" method="get">
   			 <div class="form-group">
        		<input type="submit" name="showTrains" value="Show Existing Trains" class="btn">
    		</div>
		</form>
