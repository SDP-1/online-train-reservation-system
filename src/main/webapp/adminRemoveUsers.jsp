...
<body>
    ...
    <main>
        ...
        <section class="add-manager-section">
            <h2>Remove User from the System</h2>
            <form action="deleteUserServlet" method="post">
                <div class="form-group">
                    <label for="id">Users's ID:</label>
                ...
                <div class="form-group">
                    <input type="submit" name="submit" value="Remove User" class="btn">
                </div>
            </form>

            <p>Click Below to See Existing Users:</p>
            <form action="UserListServlet" method="get">
                <div class="form-group">
                    <input type="submit" name="showUsers" value="Show Existing Users" class="btn">
                </div>
            </form>
        </section>
    </main>
