...
<head>
    ...
    <style>
        ...
        .admin-section {
            background-color: rgba(255, 255, 255, 0.7); /* transparency */
            padding: 20px;
            border-radius: 5px;
        }
...
<body>
    ...
    <main>
        ...
        <section class="add-manager-section">
            <h2>Add New Train to the System</h2>
            <form action="addTrainServlet" method="post" onsubmit="return validateForm()">
                <div class="form-group">
                    <label for="fullname">Train Name:</label>
                    <input type="text" id="fullname" name="trainName" required>
                </div>

                <div class="form-group">
                    <label for="email">Starting Station:</label>
                    <input type="text" id="email" name="trainStart" required>
                    <span class="error-message" id="email-error"></span>
                </div>

                <div class="form-group">
                    <label for="phone">Ending Station:</label>
                    <input type="text" id="phone" name="trainEnd" required>
                    <span class="error-message" id="phone-error"></span>
                </div>

                <div class="form-group">
                    <label for="username">Total Available Seats Count:</label>
                    <input type="text" id="username" name="seatCount" required>
                </div>
                
                <div class="form-group">
                    <input type="submit" name="submit" value="Add Train" class="btn">
                </div>
            </form>
        </section>
